    ...
    <section class="column-list-section container-nl">
        ...
        <div class="column-list-main-content">
            ...
            <div class="column-list-links-top">
                <a href="#" class="lpr-link-btn bg-black">すべて</a>
                <a href="#" class="lpr-link-btn">情報エンジニア科【IT領域】</a>
                <a href="#" class="lpr-link-btn">情報エンジニア科【デザイン領域】</a>
                <a href="#" class="lpr-link-btn">電子工学科</a>
                <a href="#" class="lpr-link-btn">電気設備科</a>
                <a href="#" class="lpr-link-btn">すべて</a>
                <a href="#" class="lpr-link-btn">情報エンジニア科【IT領域】</a>
                <a href="#" class="lpr-link-btn">情報エンジニア科【デザイン領域】</a>
                <a href="#" class="lpr-link-btn">電子工学科</a>
                <a href="#" class="lpr-link-btn">電気設備科</a>
            ...
            <div class="column-list-items contener-clp">
                ...
                <div href="#" class="column-list-item">
                    <a href="#" class="cl-img-box">
                        <img src="../assets/images/column-l-1.png" alt="column-l-1.png">
                    </a>
                    <div class="cl-content-section">
                        <div class="column-list-texts-top">
                            <span>2024.03.15</span>
                            <div class="cl-contente-tag-links">
                                <a href="#">情報エンジニア科【IT領域】</a>
                                <a href="#">人×AI×ロボット</a>
                            </div>
                        </div>
                        <a class="cl-text-content">OECのキャンパスで異文化交流が実現！OECのキャンパスで異文化交流が実現！</a>
                    </div>
                </div>

                <div href="#" class="column-list-item">
                    <a href="#" class="cl-img-box">
                        <img src="../assets/images/column-l-2.png" alt="column-l-1.png">
                    </a>
                    <div class="cl-content-section">
                        <div class="column-list-texts-top">
                            <span>2024.03.15</span>
                        ...
                        <a class="cl-text-content">電気設備コースから目指せる職業の種類をご紹介します。電気工事士や電気工事施工管理などの電気業界の様々な仕事を集めたお仕事図鑑です。</a>
                    </div>
                </div>

                <div href="#" class="column-list-item">
                    <a href="#" class="cl-img-box">
                        <img src="../assets/images/column-l-3.png" alt="column-l-1.png">
                    </a>
                    <div class="cl-content-section">
                        <div class="column-list-texts-top">
                            <span>2024.03.15</span>
                        ...
                        <a class="cl-text-content">この文章はダミーです。文字の大きさ、量、字間、行間等を確認するために入れています。</a>
                    </div>
                </div>

                <div href="#" class="column-list-item">
                    <a href="#" class="cl-img-box">
                        <img src="../assets/images/column-l-4.png" alt="column-l-1.png">
                    </a>
                    <div class="cl-content-section">
                        <div class="column-list-texts-top">
                            <span>2024.03.15</span>
                ...
                <div href="#" class="column-list-item">
                    <a href="#" class="cl-img-box">
                        <img src="../assets/images/column-l-5.png" alt="column-l-1.png">
                    </a>
                    <div class="cl-content-section">
                        <div class="column-list-texts-top">
                            <span>2024.03.15</span>
                ...
                <div href="#" class="column-list-item">
                    <a href="#" class="cl-img-box">
                        <img src="../assets/images/column-l-6.png" alt="column-l-1.png">
                    </a>
                    <div class="cl-content-section">
                        <div class="column-list-texts-top">
                            <span>2024.03.15</span>
            ...
            <div class="pagination">
                ...
                <a href="#" class="case-page active">1</a>
                <a href="#page2" class="case-page">2</a>
