  ...
  <div class="news-list-main-content">
    ...
    if ($tags) {
      ...
      foreach ($tags as $tag) {
        ...
        echo '<a href="' . esc_url(add_query_arg('tag', $tag->slug, get_post_type_archive_link('news'))) . '" class=" ' . esc_attr($active_class) . '">' . esc_html($tag->name) . '</a>';
      }
      echo '</div>';
    }
    ?>
  ...
  <div class="list-pages-right">
    ...
    <div class="lpr-item">
      ...
      <div class="archive-items" id="archiveItems" style="display:none;">
        ...
        <a href="<?php echo add_query_arg('filter_date', '2022-01-01', get_post_type_archive_link('news')); ?>"
